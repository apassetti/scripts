...
# BWA alignment
bwa mem -t 8 -R "@RG\tID:SRR2136533\tPL:CFTR\tSM:SRR2136533" ${ref} ${reads}/SRR2136533_1.fastq ${reads}/SRR2136533_2.fastq > ${aligned_reads}/SRR2136533.paired.sam
...
gatk Funcotator \
	...
	--reference ${ref} \
	--ref-version hg38 \
	--data-sources-path /home/mamba/Reference/Funcotator/funcotator_dataSources.v1.8.hg38.20230908s \
